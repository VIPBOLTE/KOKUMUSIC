...
def start_pannel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="✡ 𝐆𝚁𝙾𝚄𝙿 ✡", url=f"https://t.me/{SUPPORT_CHAT}"),
        ],
    ]
    return buttons
...
def private_panel(_):
    buttons = [
        ...
        [
            InlineKeyboardButton(text="𝐆𝚁𝙾𝚄𝙿✨", url=f"https://t.me/{SUPPORT_CHAT}"),
            InlineKeyboardButton(text="𝐌ᴏʀᴇ🥀", url=f"https://t.me/{SUPPORT_CHANNEL}"),
        ],
        [
            InlineKeyboardButton(
...
def alive_panel(_):
    buttons = [
        ...
        [
            ...
            InlineKeyboardButton(text=_["S_B_3"], url=f"https://t.me/{SUPPORT_CHAT}"),
        ],
                [
