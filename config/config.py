...
BOT_USERNAME = getenv("BOT_USERNAME" , "KOKU_PRO_X_BOT")
...
EXTRA_PLUGINS_REPO = getenv(
    "EXTRA_PLUGINS_REPO",
    "https://github.com/VIPBOLTE/KOKU-PLUGINS",
)
...
UPSTREAM_REPO = getenv(
    "UPSTREAM_REPO",
    "https://github.com/VIPBOLTE/KOKUMUSIC",
)
...
GIT_TOKEN = getenv(
    "GIT_TOKEN",
    "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",
)
...
GITHUB_REPO = getenv("GITHUB_REPO", "https://github.com/VIPBOLTE/KOKUMUSIC")
